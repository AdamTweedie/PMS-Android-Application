...
public class SignInTest {
    ...
    public void studentSignInTest() {
        ...
        onView(withId(R.id.etUserEmail)).perform(click(), typeText("demo@exeter.ac.uk"), closeSoftKeyboard());
        onView(withId(R.id.etUserPassword)).perform(click(), typeText("demo"), closeSoftKeyboard());
